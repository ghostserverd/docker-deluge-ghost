...
PATH_REPLACE="downloads"
PATH_REPLACE_WITH="downloads/deluge"

# ARG_PATH=$(echo "${TR_TORRENT_DIR/$PATH_REPLACE/$PATH_REPLACE_WITH}/$TR_TORRENT_NAME")
ARG_PATH="/downloads/deluge/completed/$TR_TORRENT_NAME"
